...
import { readCountMoneyController } from "../modules/moneylender/useCase/readCountMoney/index";
...
home.post("/count", (req, res, next) => {
	return readCountMoneyController.handle(req, res, next);
});
